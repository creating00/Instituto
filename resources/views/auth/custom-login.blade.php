...
<body class="bg-primary">
            ...
            <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5">
                <div class="card shadow">
                    <div class="card-header text-center bg-white">
                        <img src="{{ asset('assets/img/1.png') }}" class="img-thumbnail mb-3 mx-auto d-block" width="100" alt="Logo" />
    ...
    <footer class="custom-footer text-center text-muted small mt-5 py-3">
        Copyright &copy; <a href="http://www.eduservirtual.com.ar/" target="_blank" rel="noopener noreferrer">Creating</a> {{ date('Y') }}<br />
