...
<button class="btn btn-danger mb-2" type="button" data-toggle="modal" data-target="#bajas" hidden><i class="fas fa-minus"></i></button>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($data['estado'] == 1) { ?>
                                ...
                                <?php } else {
                                echo "<a href='alta_alumno.php?id=" . $data['idalumno'] . "'class='btn btn-warning'><i class='fa fa-user-plus' aria-hidden='true'></i></a>";
                            } ?>
                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="alta_alumno.php?id=<?php echo $data['idalumno']; ?>" class="btn btn-warning mr-2">
                                                    <i class="fa fa-user-plus" aria-hidden="true"></i>
                                                </a>
                                                <form action="esterminar_alumno.php?id=<?php echo $data['idalumno']; ?>" method="post" class="confirmar">
            ...
            <div class="modal-body">
                <form action="" method="post" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <input type="numer" placeholder="Ingrese Contacto" class="form-control celular-input" name="contacto" id="contacto">
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="form1" class="well col-lg-12" action="enviar.php" method="post" name="form1" enctype="multipart/form-data">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" id="Email" name="Email" style="width:40%;" placeholder="Email del Estudiante" aria-label="Recipient's username" aria-describedby="basic-addon2">
