...
if (!empty($_POST)) {
    ...
    if (empty($_POST['dni']) || empty($_POST['nombre']) || empty($_POST['apellido']) || empty($_POST['tutor'])){
        ...
        while($row = mysqli_fetch_array($rs))
        {
            ...
            if ($sql_update) {
                $alert = '<div class="alert alert-success" role="alert">Alumno Actualizado correctamente</div>';
            } else {
                $alert = '<div class="alert alert-danger" role="alert">Error al Actualizar el Alumno</div>';
            }
    }
}
// Mostrar Datos
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                         ...
                         <input type="numer" placeholder="Ingrese Contacto" class="form-control" name="contacto" id="contacto" class="form-control" value="<?php echo $data['contacto']; ?>">
                     </div>
                     <div class="form-group">
