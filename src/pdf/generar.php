...
$pdf->SetFont('Arial', 'B', 12);
$pdf->Cell(0, 5, utf8_decode("Comprobante de Inscripción - Nro. Factura: $nroFactura"), 0, 1, 'C');
...
$pdf->Ln(2);
$pdf->Cell(85, 5, utf8_decode('Cedula'), 0, 0, 'L');
...
$inscripcion1 = mysqli_query($conexion, "SELECT 
    curso.nombre AS curso, 
    inscripcion.fechacomienzo, 
    sedes.nombre AS sede, 
    inscripcion.importe, 
...
$pdf->Ln(3);
$pdf->SetTextColor(0, 0, 0);
$pdf->Cell(85, 5, 'Monto Total', 0, 0, 'L');
...
while ($row1 = mysqli_fetch_assoc($inscripcion1)) {
    $pdf->Cell(85, 5, "RD$" . $row1['importe'], 0, 0, 'L');
